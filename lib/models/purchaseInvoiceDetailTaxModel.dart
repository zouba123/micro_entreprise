...
class PurchaseInvoiceDetailTax {
  int id;
  int invoiceDetailId;
  int taxId;
  double percentage;
  ...
  PurchaseInvoiceDetailTax(this.id, this.invoiceDetailId, this.taxId, this.percentage, this.taxAmount);

  PurchaseInvoiceDetailTax.fromMap(Map<String, dynamic> map) {
    id = map['id'];
  ...
  Map<String, dynamic> toMap(bool _isInsert) {
    var _obj = {'id': id, 'invoiceDetailId': invoiceDetailId, 'taxId': taxId, 'percentage': percentage, 'taxAmount': taxAmount, 'modifiedAt': modifiedAt.toString(), 'businessId ': businessId};

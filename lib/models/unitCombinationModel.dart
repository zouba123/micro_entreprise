...
class UnitCombination {
  ...
  bool isSelected = false; // used when user select combination during add / update product

 UnitCombination();
  UnitCombination.fromMap(Map<String, dynamic> map) {
    id = map['id'];
    primaryUnit = map['primaryUnit'];
    secondaryUnit = map['secondaryUnit'];
    primaryUnitId = map['primaryUnitId'];
    secondaryUnitId = map['secondaryUnitId'];
    measurement = (map['measurement'] != null) ? map['measurement'].toDouble() : null;

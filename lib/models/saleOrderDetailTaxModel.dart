...
class SaleOrderDetailTax {
  ...
  SaleOrderDetailTax(this.id, this.saleOrderDetailId, this.taxId, this.percentage, this.taxAmount);

  SaleOrderDetailTax.fromMap(Map<String, dynamic> map) {
    id = map['id'];
    saleOrderDetailId = map['saleOrderDetailId'];
    taxId = map['taxId'];
  ...
  Map<String, dynamic> toMap(bool _isInsert) {
    var _obj =  {'id': id, 'saleOrderDetailId': saleOrderDetailId, 'taxId': taxId, 'percentage': percentage, 'taxAmount': taxAmount,  'modifiedAt': modifiedAt.toString(), 'businessId ': businessId};
    if (_isInsert) {

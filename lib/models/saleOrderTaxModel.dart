...
class SaleOrderTax {
  ...
  SaleOrderTax(this.id, this.saleOrderId, this.taxId, this.percentage, this.totalAmount);

  SaleOrderTax.fromMap(Map<String, dynamic> map) {
    id = map['id'];
  ...
  Map<String, dynamic> toMap(bool _isInsert) {
    var _obj =  {'id': id, 'saleOrderId': saleOrderId, 'taxId': taxId, 'percentage': percentage, 'totalAmount': totalAmount,  'modifiedAt': modifiedAt.toString(), 'businessId ': businessId};
    if (_isInsert) {

...
class PurchaseInvoiceReturnTax {
  int id;
  ...
  PurchaseInvoiceReturnTax(this.id, this.purchaseInvoiceReturnId, this.taxId, this.percentage, this.totalAmount);

  PurchaseInvoiceReturnTax.fromMap(Map<String, dynamic> map) {
    id = map['id'];

...
class QuotesGeneralReportFilterModel {
  // int saleInvoiceId;
  Account account;
  ...
  QuotesGeneralReportFilterModel();

  QuotesGeneralReportFilterModel copyFrom(QuotesGeneralReportFilterModel _obj) {
    QuotesGeneralReportFilterModel _newObj = QuotesGeneralReportFilterModel();

    _newObj.account = _obj.account;
    _newObj.quoteDateFrom = _obj.quoteDateFrom;
    _newObj.quoteDateTo = _obj.quoteDateTo;
    _newObj.netAmountFrom = _obj.netAmountFrom;
    _newObj.netAmountTo = _obj.netAmountTo;
    _newObj.quoteStatus = _obj.quoteStatus;

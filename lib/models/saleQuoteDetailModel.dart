...
//  String supplierProductCode;
  ...
  SaleQuoteDetail(this.id, this.saleQuoteId, this.productId, this.unitId, this.productUnitId, this.unitCode, this.quantity, this.invoicedQuantity, this.unitPrice, this.amount, this.productName, this.productCode, this.productTypeName, this.actualUnitPrice, this.isDelete, this.createdAt, this.modifiedAt, this.productDescription);

  SaleQuoteDetail.fromMap(Map<String, dynamic> map) {
    id = map['id'];

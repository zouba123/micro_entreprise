...
class SaleQuoteInvoice {
  ...
  SaleQuoteInvoice(this.id, this.saleInvoiceId, this.saleQuoteId);

  SaleQuoteInvoice.fromMap(Map<String, dynamic> map) {
    id = map['id'];
  ...
  Map<String, dynamic> toMap(bool _isInsert) {
    var _obj =  {'id': id, 'saleQuoteId': saleQuoteId, 'saleInvoiceId': saleInvoiceId, 'isDelete': isDelete.toString(),  'modifiedAt': modifiedAt.toString(), 'businessId ': businessId};
    if (_isInsert) {

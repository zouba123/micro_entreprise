...
class SaleInvoiceDetailTax {
  ...
  SaleInvoiceDetailTax(this.id, this.invoiceDetailId, this.taxId, this.percentage, this.taxAmount);

  SaleInvoiceDetailTax.fromMap(Map<String, dynamic> map) {
    id = map['id'];

...
class SaleQuoteTax {
  ...
  SaleQuoteTax(this.id, this.saleQuoteId, this.taxId, this.percentage, this.totalAmount);

  SaleQuoteTax.fromMap(Map<String, dynamic> map) {
    id = map['id'];
  ...
  Map<String, dynamic> toMap(bool _isInsert) {
    var _obj =  {'id': id, 'saleQuoteId': saleQuoteId, 'taxId': taxId, 'percentage': percentage, 'totalAmount': totalAmount, 'modifiedAt': modifiedAt.toString(), 'businessId ': businessId};
    if (_isInsert) {

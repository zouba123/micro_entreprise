...
class SaleInvoiceReturnTax {
  ...
  SaleInvoiceReturnTax(this.id, this.invoiceReturnId, this.taxId, this.percentage, this.totalAmount);

  SaleInvoiceReturnTax.fromMap(Map<String, dynamic> map) {
    id = map['id'];
    invoiceReturnId = map['invoiceReturnId'];
    taxId = map['taxId'];

...
class EmployeeAddScreen extends BaseRoute {
  final Account account;
  final int returnScreenId;
  final bool isAddAsEmployee;

  EmployeeAddScreen({@required a, @required o, this.account, this.returnScreenId, this.isAddAsEmployee}) : super(a: a, o: o, r: 'AccountAddScreen');

  @override
  _EmployeeAddScreenState createState() => _EmployeeAddScreenState(this.account, this.returnScreenId, this.isAddAsEmployee);
}

class _EmployeeAddScreenState extends BaseRouteState {
  File _image;
  final bool isAddAsEmployee;
...
//  TextEditingController _cPhoneCountryCode =  TextEditingController();
  ...
  EmployeeSalaryStructures employeeSalaryStructures = EmployeeSalaryStructures();

  _EmployeeAddScreenState(this.account, this.returnScreenId, this.isAddAsEmployee) : super();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          account.id == null ? global.appLocaleValues['tle_add_emp'] : global.appLocaleValues['tle_update_emp'],
                            ...
                            ? Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(global.appLocaleValues['lbl_middle_name'], style: Theme.of(context).primaryTextTheme.headline3),
                                  ],
                                ),
                              )
                            : SizedBox(),
                        ...
                        ? Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  global.appLocaleValues['lbl_alt_contactno'],
                                  style: Theme.of(context).primaryTextTheme.headline3,
                                ),
                              ],
                            ),
                        ...
                        ? Padding(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: <Widget>[
                                  CheckboxListTile(
                                    title: Text(global.appLocaleValues['tle_emp_']),
                                    value: _isEmployee,
                                    onChanged: (bool val) {
                                      setState(() {
                                        _isEmployee = val;
                                  ...
                                  CheckboxListTile(
                                    title: Text(global.appLocaleValues['lbl_worker']),
                                    value: _isWorker,
                                    onChanged: (bool val) {
                                      setState(() {
                                        _isWorker = val;
                                ...
                                child: Column(
                                  children: <Widget>[
                                    MaterialButton(
                                      ...
                                      child: Text(
                                        '${global.appLocaleValues['lbl_add_salary_payment']}',
                                      ),
                                      onPressed: () async {
                                        Navigator.of(context)
                                            ...
                                            .then((value) {
                                          if (value != null) {
                                            employeeSalaryStructures = value;
                                            print(employeeSalaryStructures.leaveCutAmount);
                                            setState(() {});
                                          }
                                        });
                                      },
                                    ...
                                    SingleChildScrollView(
                                      child: Container(
                                          ...
                                          child: Column(
                                        children: <Widget>[
                                          (employeeSalaryStructures.startDate != null)
                                              ? ListTile(
                                                  title: Text(
                                                    '${global.appLocaleValues['lbl_start_date_']}',
                                                    style: TextStyle(color: Colors.grey, fontSize: 15),
                                                  ),
                                                  trailing: Text(
                                                    '${DateFormat(br.getSystemFlagValue(global.systemFlagNameList.dateFormat)).format(DateTime.parse(employeeSalaryStructures.startDate.toString().substring(0, 10)))}',
                                                    style: TextStyle(fontSize: 18),
                                                  ))
                                              : SizedBox(),
                                          (employeeSalaryStructures.salaryType != null)
                                              ? ListTile(
                                                  title: Text(
                                                    '${global.appLocaleValues['lbl_salary_type_']}',
                                                    style: TextStyle(color: Colors.grey, fontSize: 15),
                                                  ),
                                                  trailing: Text(
                                                    '${employeeSalaryStructures.salaryType}',
                                                    style: TextStyle(fontSize: 18),
                                                  ))
                                              : SizedBox(),
                                          (employeeSalaryStructures.salary != null)
                                              ? ListTile(
                                                  title: Text(
                                                    '${global.appLocaleValues['lbl_salary']}',
                                                    style: TextStyle(color: Colors.grey, fontSize: 15),
                                                  ),
                                                  trailing: Text(
                                                    '${global.currency.symbol} ${employeeSalaryStructures.salary.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}',
                                                    style: TextStyle(fontSize: 18),
                                                  ))
                                              : SizedBox(),
                                          (employeeSalaryStructures.leaveCutAmount != null)
                                              ? ListTile(
                                                  title: Text(
                                                    '${global.appLocaleValues['lbl_leave_cut']}',
                                                    style: TextStyle(color: Colors.grey, fontSize: 15),
                                                  ),
                                                  trailing: Text(
                                                    '${global.currency.symbol} ${employeeSalaryStructures.leaveCutAmount.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}',
                                                    style: TextStyle(fontSize: 18),
                                                  ))
                                              : SizedBox(),
                                        ],
  ...
  void initState() {
    ...
    if (account != null) {
      ...
      if (isAddAsEmployee != null && isAddAsEmployee) {
        _isEmployee = true;
      } else if (isAddAsEmployee != null && !isAddAsEmployee) {
        _isEmployee = false;
        _isWorker = true;
      }
    }
  ...
  Future _onSubmit() async {
    try {
      ...
      if (_formKey.currentState.validate()) {
        if (_isWorker == false && _isEmployee == false) {
          showToast(global.appLocaleValues['vel_select_ac_type']);
        } else {
          showLoader(global.appLocaleValues['txt_wait']);
          setState(() {});
          if (_isEmployee == true && _isWorker == false) {
            _accountType = 'Employee';
          } else if (_isEmployee == false && _isWorker == true) {
            _accountType = 'Worker';
          } else if (_isEmployee == true && _isWorker == true) {
            _accountType = ',Employee,Worker,';
          }
          ...
          if (account.id == null) {
            ...
            account.id = _result;
            if (account.id != null) {
              if (employeeSalaryStructures.salary != null) {
                if (employeeSalaryStructures.id == null) {
                  employeeSalaryStructures.accountId = account.id;
          ...
          if (_result > 0) {
            ...
            Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (BuildContext context) => EmployeeScreen(
                      redirectToCustomersTab: (isAddAsEmployee) ? true : false,
                      a: widget.analytics,
                      o: widget.observer,

...
// class ExportAccountScreen extends BaseRoute {
//   final String timePeriod;
//   final String dateRange;
//   ExportAccountScreen({@required a, @required o, this.timePeriod, this.dateRange}) : super(a: a, o: o, r: 'ExportAccountScreen');
//   @override
//   _ExportAccountScreenState createState() => _ExportAccountScreenState(this.timePeriod, this.dateRange);
// }

// class _ExportAccountScreenState extends BaseRouteState {
//   final String timePeriod;
//   final String dateRange;
//   List<Account> _accountList =  List();
//   bool _isDataLoaded = false;
//   bool _isPrint = false;
//   _ExportAccountScreenState( this.timePeriod, this.dateRange) : super();
...
//       appBar: AppBar(
//         title: Text('${global.appLocaleValues['tle_ac_export']}'),
//         actions: <Widget>[
//           (_isDataLoaded && _accountList.length > 0)
//               ? IconButton(
...
//                                     ),
//                                     DataColumn(
//                                       label: Text(global.appLocaleValues['tle_ac_code'], style: TextStyle(fontSize: 10)),
//                                     ),
//                                     DataColumn(label: Text(global.appLocaleValues['lbl_name'], style: TextStyle(fontSize: 10))),
//                                     DataColumn(label: Text(global.appLocaleValues['lbl_contact_'], style: TextStyle(fontSize: 10))),
//                                     DataColumn(label: Text(global.appLocaleValues['lbl_gender'], style: TextStyle(fontSize: 10))),
//                                     DataColumn(label: Text(global.appLocaleValues['txt_birthday'], style: TextStyle(fontSize: 10))),
//                                     DataColumn(label: Text(global.appLocaleValues['txt_address'], style: TextStyle(fontSize: 10))),
//                                     DataColumn(label: Text(global.appLocaleValues['tle_Registeres_on'], style: TextStyle(fontSize: 10))),
//                                     DataColumn(
//                                       label: Text(global.appLocaleValues['tle_business'], style: TextStyle(fontSize: 10)),
//                                     ),
//                                     DataColumn(
//                                       label: Text('${global.appLocaleValues['lbl_gst_no_']}', style: TextStyle(fontSize: 10)),
//                                     ),
//                                   ],
//                                   rows: _accountList
//                                       .map((f) => DataRow(cells: [
//                                             DataCell((_accountList != null) ? Text((_accountList.indexOf(f) + 1).toString()) : Text('')),
...
//                               (_accountList.isNotEmpty) ? Text('${global.currency.symbol} ${_accountList.map((b) => b.amount).reduce((sum, amount) => sum + amount).round()}') : Text(''),
//                             ],
//                           ),
//                         ),
//                       ),
...
//         SalesStatement _salesStatment =  SalesStatement(_saleInvoiceList[i].invoiceDate, br.generateAccountName(_saleInvoiceList[i].account), _saleInvoiceList[i].invoiceNumber, _saleInvoiceList[i].netAmount, _saleInvoiceList[i].status, _saleInvoiceList[i].netAmount);
...
//           double _saleReturnAmount = _saleInvoiceReturnList.map((f) => f.netAmount).reduce((sum, amt) => sum + amt);
//           _salesStatment.amount -= _saleReturnAmount;
//         }

//         if (_salesStatment.amount > 0) {
//           _accountList.add(_salesStatment);
//         }
//       }
//       setState(() {});
//     } catch (e) {
//       print('Exception - ExportAccountScreen.dart - _getData(): ' + e.toString());
//     }
//   }

//   Future _printReport(_isPrint) async {
//     try {
//       double _amount = _accountList.map((b) => b.amount).reduce((sum, amount) => sum + amount);
//       var htmlContent = """
//     <!DOCTYPE html>
// <html>
// <head>
...
//       _accountList.forEach((item) {
//         htmlContent += """
//       <tr>
//     <td>${(_accountList.indexOf(item)) + 1}</td>
...
//       }
//     } catch (e) {
//       print('Exception - ExportAccountScreen.dart - _printReport(): ' + e.toString());
//     }
//   }
// }

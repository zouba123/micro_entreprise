...
class SaleOrderDetailScreen extends BaseRoute {
  final SaleOrder order;
  final int screenId;
  SaleOrderDetailScreen({@required a, @required o, @required this.order, this.screenId}) : super(a: a, o: o, r: 'SaleOrderDetailScreen');

  @override
  _SaleOrderDetailScreenState createState() => _SaleOrderDetailScreenState(this.order, this.screenId);
}

class _SaleOrderDetailScreenState extends BaseRouteState {
  SaleOrder order;
  bool _isPrintAction;
  ...
  _SaleOrderDetailScreenState(this.order, this.screenId) : super();
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: AppBar(
            title: Text(
              '${br.getSystemFlagValue(global.systemFlagNameList.invoiceNoPrefix)}${'0' * (int.parse(br.getSystemFlagValue(global.systemFlagNameList.invoiceNoMaxLength)) - (br.getSystemFlagValue(global.systemFlagNameList.invoiceNoPrefix).length + order.saleOrderNumber.toString().length))}${order.saleOrderNumber}',
              ...
              Padding(
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    ...
                    _isPrintAction = true;
                    await br.generateSaleOrderHtml(
                      context,
                      order: order,
              ...
              Padding(
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    ...
                    await br.generateSaleOrderHtml(context, order: order, isPrintAction: _isPrintAction);
                  },
                ),
              ),
            ],
                    ...
                    children: <Widget>[
                      Column(
                        children: [
                            ...
                            child: Card(
                              child: ListTile(
                                  ...
                                  subtitle: Row(
                                    children: [
                                      Text(
                                        '${br.generateAccountName(order.account)}',
                                  ...
                                  onTap: () async {
                                    ...
                                    // order.account.totalPaid -= returnSaleInvoiceAmount;
                                    order.account.totalDue = order.account.totalSpent - order.account.totalPaid;
                          ...
                          Padding(
                            ...
                            child: Card(
                              child: ListTile(
                                  contentPadding: EdgeInsets.only(left: 10),
                                  title: Text(
                                    "${global.appLocaleValues['sal_odr_typ']}",
                                    // ${global.appLocaleValues['lbl_sale_invoice_type']}",
                                    style: Theme.of(context).primaryTextTheme.headline1,
                                  ),
                                  subtitle: Text(
                                    '${(order.orderTaxList.length > 0) ? global.appLocaleValues['tle_with_tax'] : global.appLocaleValues['tle_without_tax']}',
                                    style: Theme.of(context).primaryTextTheme.headline3,
                                  )),
                            ),
                          ),
                                ...
                                Expanded(
                                  child: Card(
                                    ...
                                    child: ListTile(
                                        ...
                                        subtitle: Text(
                                          '${DateFormat(br.getSystemFlagValue(global.systemFlagNameList.dateFormat)).format(order.deliveryDate)}  ${DateFormat("HH:mm a").format(order.deliveryDate)}',
                                          style: Theme.of(context).primaryTextTheme.headline3,
                                        )),
                                  ),
                                ),
                          ...
                          //   child: Row(
                          //     children: [
                          //       (order.saleInvoiceNumber != null && order.saleInvoiceId != null)
                          //           ? Expanded(
                          //               child: Card(
                          //                 child: ListTile(
                          //                     onTap: () async {
                          //                       List<SaleInvoice> _list = await dbHelper.saleInvoiceGetList(invoiceIdList: [order.saleInvoiceId]);
                          ...
                          //       //         contentPadding: EdgeInsets.only(left: 10),
                          //       //         title: Text(
                          //       //           "${global.appLocaleValues['lbl_delivery_date_time']}",
                          //       //           style: Theme.of(context).primaryTextTheme.headline1,
                          //       //         ),
                          //       //         subtitle: Text(
                          //       //           '${DateFormat('dd-MM-yyyy : hh-mm').format(order.deliveryDate)}',
                          //       //           // '${DateFormat(br.getSystemFlagValue(global.systemFlagNameList.dateFormat)).format(order.deliveryDate)}  $time',
                          //       //           style: Theme.of(context).primaryTextTheme.headline3,
                          //       //         )),
                          //       //   ),
                          //       // ),
                                ...
                                Expanded(
                                  child: Card(
                                    child: ListTile(
                                        ...
                                        subtitle: Text(
                                          '${order.showRemarkInPrint ? 'Yes' : 'No'}',
                                          // '${DateFormat(br.getSystemFlagValue(global.systemFlagNameList.dateFormat)).format(order.orderDate)}',
                                          style: Theme.of(context).primaryTextTheme.headline3,
                                        )),
                                  ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                (order.salesQuoteNumber != null && order.salesQuoteVersion != null)
                                    ? Expanded(
                                        child: Card(
                                          margin: EdgeInsets.only(top: 5, bottom: 5),
                                          child: ListTile(
                                              onTap: () async {
                                                List<SaleQuote> _list = await dbHelper.saleQuoteGetList(orderIdList: [order.salesQuoteId]);
                                                if (_list != null && _list.length > 0) {
                                              ...
                                              subtitle: Text(
                                                '${br.getSystemFlagValue(global.systemFlagNameList.invoiceNoPrefix)}${'0' * (int.parse(br.getSystemFlagValue(global.systemFlagNameList.invoiceNoMaxLength)) - (br.getSystemFlagValue(global.systemFlagNameList.invoiceNoPrefix).length + order.salesQuoteNumber.toString().length))}${order.salesQuoteNumber}-${order.salesQuoteVersion}',
                                                style: Theme.of(context).primaryTextTheme.headline3,
                                              )),
                                        ),
                                      )
                                    : SizedBox(),
                                (order.salesInvoiceId != null && order.salesInvoiceNumber != null)
                                    ? Expanded(
                                        child: Card(
                                          margin: EdgeInsets.only(top: 5, bottom: 5),
                                          child: ListTile(
                                              onTap: () async {
                                                List<SaleInvoice> _list = await dbHelper.saleInvoiceGetList(invoiceIdList: [order.salesInvoiceId]);
                                                if (_list != null && _list.length > 0) {
                                              ...
                                              title: Text(
                                                "${global.appLocaleValues['tle_invoice']}",
                                                style: Theme.of(context).primaryTextTheme.headline1,
                                              ),
                                              subtitle: Text(
                                                '${br.getSystemFlagValue(global.systemFlagNameList.invoiceNoPrefix)}${'0' * (int.parse(br.getSystemFlagValue(global.systemFlagNameList.invoiceNoMaxLength)) - (br.getSystemFlagValue(global.systemFlagNameList.invoiceNoPrefix).length + order.salesInvoiceNumber.toString().length))}${order.salesInvoiceNumber}',
                                                style: Theme.of(context).primaryTextTheme.headline3,
                                              )),
                                        ),
                                      )
                      ...
                      order.orderDetailList.length > 0
                          ? Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  ListView.builder(
                                    ...
                                    itemCount: order.orderDetailList.length, // order.orderDetailList.length,
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Expanded(
                                                  child: Text(
                                                '${order.orderDetailList[index].productName}',
                                                style: Theme.of(context).primaryTextTheme.overline,
                                              )),
                                              SizedBox(
                                                width: 10,
                                              ...
                                              (br.getSystemFlagValue(global.systemFlagNameList.enableUnitModule) == "true")
                                                  ? Container(
                                                      width: 60,
                                                      child: Text(
                                                        '${order.orderDetailList[index].unitCode}',
                                                        style: Theme.of(context).primaryTextTheme.overline,
                                                        textAlign: TextAlign.center,
                                                      ))
                                                  : SizedBox(),
                                              Container(
                                                width: 70,
                                                child: Text(
                                                  '${global.currency.symbol} ${order.orderDetailList[index].unitPrice.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}',
                                                  textAlign: TextAlign.right,
                                                  style: Theme.of(context).primaryTextTheme.overline,
                                                ),
                                              ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              ' ${global.currency.symbol} ${order.grossAmount.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}',
                              style: Theme.of(context).primaryTextTheme.overline,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              ' ${global.currency.symbol} ${order.discount.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}',
                              style: Theme.of(context).primaryTextTheme.overline,
                              textAlign: TextAlign.end,
                            )
                          ],
                      ...
                      (order.finalTax != null && order.finalTax > 0)
                          ? ListView.builder(
                              physics: NeverScrollableScrollPhysics(),
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      (order.orderDetailTaxList.length != 0) ? Text('${order.orderTaxList[index].taxName}', style: Theme.of(context).primaryTextTheme.subtitle2) : Text('${order.orderTaxList[index].taxName}(${order.orderTaxList[index].percentage.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}%)', style: Theme.of(context).primaryTextTheme.subtitle2),
                                      Text(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              ' ${global.currency.symbol} ${order.netAmount.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}',
                              style: Theme.of(context).primaryTextTheme.overline,
                              textAlign: TextAlign.end,
                            ),
                          ],
                      ...
                      Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '${global.currency.symbol} ${order.advanceAmount.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}',
                                style: Theme.of(context).primaryTextTheme.overline,
                              ),
                            ],
                          )),
                      Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              (order.remainAmount >= 0) ? Text(' ${global.appLocaleValues['lbl_due']}', style: Theme.of(context).primaryTextTheme.subtitle2) : Text(' ${global.appLocaleValues['lbl_credit']}', style: Theme.of(context).primaryTextTheme.subtitle2),
                              (order.remainAmount >= 0)
                                  ? Text(
                                      '${global.currency.symbol} ${order.remainAmount.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}',
                                      style: Theme.of(context).primaryTextTheme.overline,
                                    )
                                  : Text(
                                      '${global.currency.symbol} ${order.remainAmount.toStringAsFixed(int.parse(br.getSystemFlagValue(global.systemFlagNameList.decimalPlaces)))}',
  ...
  Future _getData() async {
    try {
      ...
      order.orderDetailList = await dbHelper.saleOrderDetailGetList(orderIdList: [order.id]);
      ...
      List<Account> _accountList = await dbHelper.accountGetList(accountId: order.accountId);
      order.account = _accountList[0];
      ...
      // if (order.remainAmount == null) {
      order.remainAmount = (_paymentList.length != 0) ? (order.netAmount - (_receivedAmount - _givenAmount)) : order.netAmount;
      // }
      // order.remainAmount = 0;
      _isdataLoaded = true;
      setState(() {});
    } catch (e) {
      print('Exception - SaleOrderDetailScreen - _getData(): ' + e.toString());
      return null;
    }
  }
